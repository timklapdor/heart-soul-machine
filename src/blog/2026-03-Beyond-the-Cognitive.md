---
title: "Beyond the Cognitive: Rethinking Bloom’s Taxonomy"
aliases:
category:
  - "[[Blog]]"
status:
...
![By Tidema - Own work, CC BY 4.0, https://commons.wikimedia.org/w/index.php?curid=152872571](https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/Bloom%27s_revised_taxonomy.svg/3840px-Bloom%27s_revised_taxonomy.svg.png)

I was really only familiar with this view of Bloom's, and it wasn't until I was well and truly down a rabbit hole - bouncing from [Frontier Modalities of Learning for Top Performance](https://magur.no/essays/frontier-modalities-of-learning-for-top-performance/) to [Reverse Bloom Learning Framework](https://coming.gr/wp-content/uploads/2020/12/2_December2020_JEICOM_FINAL_Arthur-W-Shelley.pdf) - that I learnt that Bloom always intended the cognitive domain to be accompanied by two companion frameworks: one for the Affective domain (emotions, attitudes, dispositions) and one for the Psychomotor domain (physical and spatial skill). These were developed later –Krathwohl for the Affective, Simpson for the Psychomotor – but they’ve never really entered mainstream educational practice the way the cognitive taxonomy has. They also lacked some of the clarity that helped with the adoption of Bloom's. But it's telling that the systemic approach to conceptualising learning, particularly in Higher Education, is only the cognitive domain. 

An influential concept for me is from a talk that Bret Victor gave, [The Humane Representation of Thought](https://vimeo.com/115154289) , in which he discusses the different models developed to articulate understanding:
